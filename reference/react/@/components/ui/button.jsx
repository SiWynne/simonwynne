...
const buttonVariants = cva("inline-flex items-center justify-center gap-3 rounded-button whitespace-nowrap transition-all duration-200 ease-in-out focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50", {
    variants: {
        variant: {
            default: "border-2 border-neutral-darkest bg-milan-lighter font-medium text-neutral-darkest shadow-[inset_0_4px_0_0_var(--color-white-20),inset_0_-5px_0_0_var(--color-neutral-darkest-15),0_2px_2px_0_var(--color-neutral-darkest-15)] hover:-translate-y-0.5 hover:bg-milan-lightest hover:shadow-[inset_0_4px_0_0_var(--color-white-20),inset_0_-5px_0_0_var(--color-neutral-darkest-15),0_4px_4px_0_var(--color-neutral-darkest-15)]",
            alternate: "border-2 border-neutral-darkest bg-milan-lighter font-medium text-neutral-darkest shadow-[inset_0_4px_0_0_var(--color-white-20),inset_0_-5px_0_0_var(--color-neutral-darkest-15),0_2px_2px_0_var(--color-neutral-darkest-15)] hover:-translate-y-0.5 hover:bg-milan-lightest hover:shadow-[inset_0_4px_0_0_var(--color-white-20),inset_0_-5px_0_0_var(--color-neutral-darkest-15),0_4px_4px_0_var(--color-neutral-darkest-15)]",
