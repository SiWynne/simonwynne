    ...
    <div className="relative">
      <div className="absolute -ml-8 flex h-full w-8 items-start justify-center">
        <motion.div
          ...
          className="z-20 mt-9 size-3.75 rounded-full shadow-[0_0_0_8px_var(--color-scheme-background)] md:mt-12"
        />
      </div>
      <Card className="ml-4 flex flex-col p-6 md:ml-12 md:p-8">
        <h3 className="mb-3 text-h3 font-bold md:mb-4">{item.heading}</h3>
